...
using UnityEngine;
    ...
    {
        if (col.gameObject.tag == "park")
        {
            collis = collis + 1;
        }
        if (collis == 1) {
            sh1.SetActive(!sh1.activeSelf);
        }
        if (collis == 2)
        {
            sh2.SetActive(!sh2.activeSelf);
        }
        if (collis == 3)
        {
            sh3.SetActive(!sh3.activeSelf);
        }
        if (collis == 4)
        {
            sh4.SetActive(!sh4.activeSelf);
        }
        if (collis == 5)
        {
            sh5.SetActive(!sh5.activeSelf);
